...
//                mavenBundle("org.ops4j.pax.exam", "pax-exam-extender-service").versionAsInProject(),
//                mavenBundle("org.ops4j.pax.exam", "pax-exam-inject").versionAsInProject(),
                // Pax-Web
...
//                mavenBundle().groupId("org.ops4j.pax.logging").artifactId("pax-logging-service").versionAsInProject(),
                // Others
                mavenBundle().groupId("org.ops4j.pax.url").artifactId("pax-url-aether").versionAsInProject().type("jar"),
                mavenBundle().groupId("org.ops4j.pax.url").artifactId("pax-url-war").type("jar").classifier("uber").versionAsInProject(),
